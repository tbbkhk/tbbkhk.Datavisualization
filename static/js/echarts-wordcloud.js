...
function(t) {
	return function(t) {
		...
		function i(t, e, r) {
			...
			for (var a in e) if (e.hasOwnProperty(a)) {
				var o = t[a],
				s = e[a]; ! S(s) || !S(o) || w(s) || w(o) || T(s) || T(o) || M(s) || M(o) || F(s) || F(o) ? !r && a in t || (t[a] = n(e[a], !0)) : i(o, s, r)
			}
			return t
		}
		function a(t, e) {
		...
		function d(t, e, r) {
			if (t && e) if (t.forEach && t.forEach === H) t.forEach(e, r);
			else if (t.length === +t.length) for (var n = 0,
			i = t.length; n < i; n++) e.call(r, t[n], n, t);
		...
		function g(t, e, r, n) {
			if (t && e) {
				...
				for (var i = 0,
				a = t.length; i < a; i++) r = e.call(n, r, t[i], i, t);
				return r
			}
		}
		function p(t, e, r) {
		...
		function m(t, e, r) {
			if (t && e) for (var n = 0,
			i = t.length; n < i; n++) if (e.call(r, t[n], n, t)) return t[n]
		}
		function x(t, e) {
		...
		function C(t) {
			for (var e = 0,
			r = arguments.length; e < r; e++) if (null != arguments[e]) return arguments[e]
		}
		function P(t, e) {
			return null != t ? t: e
		}
		...
		n.prototype = {
			...
			brush: function(t, e) {
				...
				if (r.bind(t, this, e), this.setTransform(t), this.__dirty) {
					var v;
					l && (v = v || this.getBoundingRect(), this._fillGradient = r.getGradient(t, o, v)),
					u && (v = v || this.getBoundingRect(), this._strokeGradient = r.getGradient(t, s, v))
				}
				...
				n.setScale(x[0], x[1]),
				this.__dirtyPath || g && !m && i ? (n.beginPath(t), g && !m && (n.setLineDash(g), n.setLineDashOffset(p)), this.buildPath(n, this.shape, !1), this.path && (this.__dirtyPath = !1)) : (t.beginPath(), this.path.rebuildPath(t)),
				a && n.fill(t),
			...
			setShape: function(t, e) {
				var r = this.shape;
				if (r) {
					if (a.isObject(t)) for (var n in t) t.hasOwnProperty(n) && (r[n] = t[n]);
					else r[t] = e;
					this.dirty(!0)
				}
				return this
	...
	function(t, e) {
		...
		function g(t, e) {
			var r = h(e);
			return 0 === r ? (t[0] = 0, t[1] = 0) : (t[0] = e[0] / r, t[1] = e[1] / r),
			t
		}
		function p(t, e) {
	...
	function(t, e, r) {
		...
		function u(t, e, r, n, i, o, s, l, h, u, c) {
			...
			k[0] = h,
			k[1] = u;
			for (var w = 0; w < 1; w += .05) C[0] = a(t, r, i, s, w),
			C[1] = a(e, n, o, l, w),
			(g = y(k, C)) < x && (f = w, x = g);
			x = 1 / 0;
			...
			C[1] = a(e, n, o, l, d),
			g = y(C, k),
			d >= 0 && g < x ? (f = d, x = g) : (P[0] = a(t, r, i, s, v), P[1] = a(e, n, o, l, v), p = y(P, k), v <= 1 && p < x ? (f = v, x = p) : m *= .5);
	...
	function(t, e, r) {
		...
		function o(t, e, r, n, a, o) {
			...
			d = h(0, c, n),
			v = new _(f, d, u, c);
			return v.lineHeight = s.lineHeight,
			v
		}
		...
		function m(t, e, r, n) {
			...
			if (r && (s += r[0] + r[2]), t && n) {
				...
				if (null != l && s > l) t = "",
				a = [];
				else if (null != h) for (var u = f(h - (r ? r[1] + r[3] : 0), e, n.ellipsis, {
					minChar: n.minChar,
		...
		function x(t, e) {
			...
			for (var m = 0; m < s.length; m++) {
				for (var x = s[m], w = 0, _ = 0, S = 0; S < x.tokens.length; S++) {
					...
					var D = T.textWidth,
					L = null == D || "auto" === D;
					if ("string" == typeof D && "%" === D.charAt(D.length - 1)) M.percentWidth = D,
					u.push(M),
					D = 0;
					else {
						if (L) {
	...
	function(t, e, r) {
		...
		_.prototype = {
			...
			bezierCurveTo: function(t, e, r, n, i, a) {
				return this.addData(h.C, t, e, r, n, i, a),
			...
			quadraticCurveTo: function(t, e, r, n) {
				return this.addData(h.Q, t, e, r, n),
			...
			arc: function(t, e, r, n, i, a) {
				return this.addData(h.A, t, e, r, r, n, i - n, 0, a ? 0 : 1),
			...
			_dashedLineTo: function(t, e) {
				...
				p = h,
				m = o.length;
				for (u /= f, c /= f, a < 0 && (a = i + a), a %= i, d -= a * u, p -= a * c; u > 0 && d <= t || u < 0 && d >= t || 0 == u && (c > 0 && p <= e || c < 0 && p >= e);) n = this._dashIdx,
				r = o[n],
				d += u * r,
				p += c * r,
				this._dashIdx = (n + 1) % m,
				u > 0 && d < l || u < 0 && d > l || c > 0 && p < h || c < 0 && p > h || s[n % 2 ? "moveTo": "lineTo"](u >= 0 ? v(d, t) : g(d, t), c >= 0 ? v(p, e) : g(p, e));
				u = d - t,
				c = p - e,
				this._dashOffset = -x(u * u + c * c)
			},
			_dashedBezierTo: function(t, e, r, i, a, o) {
				...
				b = v.length,
				S = 0;
				for (d < 0 && (d = f + d), d %= f, s = 0; s < 1; s += .1) l = y(p, t, r, a, s + .1) - y(p, t, r, a, s),
				h = y(m, e, i, o, s + .1) - y(m, e, i, o, s),
				w += x(l * l + h * h);
				for (; _ < b && !((S += v[_]) > d); _++);
				for (s = (S - d) / w; s <= 1;) u = y(p, t, r, a, s),
				c = y(m, e, i, o, s),
			...
			getBoundingRect: function() {
				...
				l = 0; l < t.length;) {
					...
					case h.L:
						...
						break;
					case h.C:
						a.fromCubic(e, r, t[l++], t[l++], t[l++], t[l++], t[l], t[l + 1], f, d),
						e = t[l++],
						r = t[l++];
						break;
					case h.Q:
			...
			rebuildPath: function(t) {
				...
				f = 0; f < c;) {
					...
					case h.L:
						a = s[f++],
						o = s[f++],
						(y(a - n) > l || y(o - i) > u || f === c - 1) && (t.lineTo(a, o), n = a, i = o);
						break;
					case h.C:
					...
					case h.A:
						...
						P = Math.abs(x - w) > .001,
						I = _ + b;
						P ? (t.translate(v, g), t.rotate(S), t.scale(k, C), t.arc(0, 0, T, _, I, 1 - M), t.scale(1 / k, 1 / C), t.rotate( - S), t.translate( - v, -g)) : t.arc(v, g, T, _, I, 1 - M),
	...
	function(t, e, r) {
		...
		function c(t, e, r) {
			...
			0);
			if (0 === n) return 0;
			for (var i = Math.pow(10, r), a = w.map(t,
			function(t) {
			...
			function(t, e) {
				...
				c = null,
				f = 0,
				d = h.length; f < d; ++f) h[f] > u && (u = h[f], c = f); ++s[c],
				h[c] = 0,
				++l
			}
			return s[e] / i
		...
		function v(t) {
			...
			if ("string" == typeof t) {
				...
				if (e[8]) {
					var r = +e[4] || 0;
					return "Z" !== e[8].toUpperCase() && (r -= e[8].slice(0, 3)),
					new Date(Date.UTC( + e[1], +(e[2] || 1) - 1, +e[3] || 1, r, +(e[5] || 0), +e[6] || 0, +e[7] || 0))
				}
		...
		function m(t, e) {
			...
			i = Math.pow(10, n),
			a = t / i;
			return r = e ? a < 1.5 ? 1 : a < 2.5 ? 2 : a < 4 ? 3 : a < 7 ? 5 : 10 : a < 1 ? 1 : a < 2 ? 2 : a < 3 ? 3 : a < 5 ? 5 : 10,
			t = r * i,
	...
	function(t, e, r) {
		...
		function _(t, e) {
			if ((t = d(t)) && null != e) return t[3] = a(e),
			b(t, "rgba")
		}
		function b(t, e) {
			if (t && t.length) {
	...
	function(t, e, r) {
		...
		function o(t, e, r, n, i) {
			...
			F && g(e, "fillStyle", F);
			for (var R = 0; R < u.length; R++) L && e.strokeText(u[R], T, k),
			F && e.fillText(u[R], T, k),
			k += d
		}
		...
		function l(t, e, r, n, i) {
			...
			for (var M = 0; M < r.lines.length; M++) {
				for (var T, k = r.lines[M], C = k.tokens, I = C.length, A = k.lineHeight, O = k.width, D = 0, L = _, F = S, R = I - 1; D < I && (T = C[D], !T.textAlign || "left" === T.textAlign);) u(t, e, T, n, A, b, L, "left"),
				O -= T.width,
				L += T.width,
				D++;
				for (; R >= 0 && (T = C[R], "right" === T.textAlign);) u(t, e, T, n, A, b, F, "right"),
				O -= T.width,
				F -= T.width,
				R--;
				for (L += (a - (L - _) - (S - F) - O) / 2; D <= R;) T = C[D],
		...
		function u(t, e, r, n, i, a, o, s) {
			...
			u = a + i / 2;
			"top" === h ? u = a + r.height / 2 : "bottom" === h && (u = a + i - r.height / 2),
			!r.isLineHolder && c(l) && f(t, e, l, "right" === s ? o - r.width: "center" === s ? o - r.width / 2 : o, u - r.height / 2, r.width, r.height);
			var d = r.textPadding;
			...
			v && (g(e, "lineWidth", w), g(e, "strokeStyle", v), e.strokeText(r.text, o, u)),
		...
		function v(t, e, r) {
			...
			if (r) {
				...
				if (s instanceof Array) n = r.x + x(s[0], r.width),
				i = r.y + x(s[1], r.height);
				else {
		...
		function n(t, e, r) {
			...
			if (n && n.length >= 2) {
				if (o && "spline" !== o) {
					...
					t.moveTo(n[0][0], n[0][1]);
					for (var h = 1,
					d = n.length; h < d; h++) t.lineTo(n[h][0], n[h][1])
				}
				r && t.closePath()
			}
		}
	...
	function(t, e, r) {
			...
			function(r) {
				...
				r.layoutInstance = {
					...
					dispose: function() {
						...
						u.addEventListener("wordclouddrawn",
						function(t) {
							t.preventDefault()
						})
					}
		...
		i.registerPreprocessor(function(t) {
			...
			var r = (t || {}).series; ! i.util.isArray(r) && (r = r ? [r] : []);
		...
		function n(t, e, r, n, i) {
			...
			e.eachChild(function(l, h) {
				...
				if ("horizontal" === t) {
					...
					u = a + p,
					u > n || l.newline ? (a = 0, u = p, o += s + r, s = d.height) : s = Math.max(s, d.height)
				} else {
		...
		function l(t, e, r) {
			function n(r, n) {
				...
				function(t) {
					...
					a(o, t) && l++,
					a(h, t) && u++
				}), s[n]) return a(e, r[1]) ? h[r[2]] = null: a(e, r[2]) && (h[r[1]] = null),
				h;
				if (2 !== u && l) {
					if (l >= 2) return o;
			...
			var s = r.ignoreSize; ! c.isArray(s) && (s = [s, s]);
			var l = n(x[0], 0),
			h = n(x[1], 1);
			o(x[0], t, l),
			o(x[1], t, h)
	...
	function(t, e, r) {
		function n(t, e, r) {
			...
			for (var w = 0; w < x; w++) {
				...
				null != b && null == g.get(b) && (S.name = S.tooltipName = b, g.set(b, w)),
			...
			for (var T = r.extraPrefix || "value",
			k = 0; k < x; k++) {
				var S = m[k] = m[k] || {};
				null == S.coordDim && (S.coordDim = o(T, p, r.extraFromZero), S.coordDimIndex = 0, S.isExtraCoord = !0),
	...
	function(t, e, r) {
			...
			function(t, n) {
				if (M(t)) {
					...
					for (var i = 0; i < r.length; i++) {
						var a = r[i].exist;
						if (! (r[i].option || null != a.id && null != t.id || null == t.name || c(t) || c(a) || a.name !== t.name + "")) return r[i].option = t,
						void(e[n] = null)
					}
				}
			}),
		...
		function u(t) {
			...
			function(t, r) {
				var n = t.option;
				y.assert(!n || null == n.id || !e.get(n.id) || e.get(n.id) === t, "id duplicates: " + (n && n.id)),
		...
		function f(t, e) {
			function r(t, e, r) {
				for (var i = 0,
				a = t.length; i < a; i++) for (var o = t[i].seriesId, s = n(t[i].dataIndex), l = r && r[o], h = 0, u = s.length; h < u; h++) {
					var c = s[h];
			...
			function i(t, e) {
				var r = [];
				for (var n in t) if (t.hasOwnProperty(n) && null != t[n]) if (e) r.push( + n);
				else {
					var a = i(t[n], !0);
					a.length && r.push({
						seriesId: n,
		...
		function d(t, e) {
			return null != e.dataIndexInside ? e.dataIndexInside: null != e.dataIndex ? y.isArray(e.dataIndex) ? y.map(e.dataIndex,
			function(e) {
				return t.indexOfRawIndex(e)
			}) : t.indexOfRawIndex(e.dataIndex) : null != e.name ? y.isArray(e.name) ? y.map(e.name,
			function(e) {
		...
		function v(t, e, r) {
			...
			var i = r && r.defaultMainType; ! i || x(e, i + "Index") || x(e, i + "Id") || x(e, i + "Name") || (e[i + "Index"] = 0);
			var a = {};
			return S(e,
			function(n, i) {
				var n = e[i];
	...
	function(t, e, r) {
		...
		function o(t) {
			...
			return t && (t = t.split(g), e.main = t[0] || "", e.sub = t[1] || ""),
			e
		}
		function s(t) {
	...
	function(t, e, r) { (function(t) {
			var r;
			"undefined" != typeof window ? r = window.__DEV__: void 0 !== t && (r = t.__DEV__),
			void 0 === r && (r = !0);
			var n = r;
			e.__DEV__ = n
		}).call(e, r(34))
	...
	function(t, e, r) {
		...
		function a(t, e, r, n) {
			...
			a = i.getBoundingRect();
			return r && ("center" === n && (r = s(r, a)), l(i, r)),
			i
		}
		function o(t, e, r) {
			var n = new K({
		...
		function h(t) {
			var e = t.shape,
			r = t.style.lineWidth;
			return vt(2 * e.x1) === vt(2 * e.x2) && (e.x1 = e.x2 = c(e.x1, r, !0)),
		...
		function g(t) {
			if (!t.__isHover) {
				if (v(t), t.useHoverLayer) t.__zr && t.__zr.addHover(t, t.__hoverStl);
					...
					r && (D(e, e.insideOriginalTextPosition, r), null == e.textFill && (e.textFill = r.autoColor)),
					t.dirty(!1),
					t.z2 += 1
				}
				t.__isHover = !0
		...
		function P(t, e, r, n) {
			if (r = r || mt, r.isRectText) {
				...
				t.textRotation = a,
				t.textDistance = Y.retrieve2(e.getShallow("distance"), n ? null: 5)
			}
			var o, s = e.ecModel,
		...
		function D(t, e, r) {
			...
			t.textFill = "#fff", null == t.textStroke && (t.textStroke = r.autoColor, null == t.textStrokeWidth && (t.textStrokeWidth = 2))),
			n
		}
		function L(t) {
		...
		function N(t, e) {
			for (var r = U.identity([]); t && t !== e;) U.mul(r, t.getLocalTransform(), r),
			t = t.parent;
			return r
		}
		function E(t, e, r) {
			return e && !Y.isArrayLike(e) && (e = Q.getLocalTransform(e)),
			r && (e = U.invert([], e)),
			$.applyTransform([], t, e)
		}
		function W(t, e, r) {
		...
		function q(t, e, r, n) {
			function i(t) {
				...
				return t.shape && (e.shape = Y.extend({},
				t.shape)),
				e
			}
			if (t && e) {
		...
		function i(t) {
			...
			for (e = 1; e < a.length; e++) {
				...
				for (; g < p.length && !isNaN(p[g]) && !isNaN(p[0]);) {
					...
					case "c":
						c = h.C,
						l.addData(c, p[g++] + o, p[g++] + s, p[g++] + o, p[g++] + s, p[g++] + o, p[g++] + s),
						o += p[g - 2],
						s += p[g - 1];
						break;
					case "S":
	...
	function(t, e) {
		function r(t, e, r) {
			...
			a = null == e.y ? 0 : e.y,
			o = null == e.y2 ? 0 : e.y2;
			return e.global || (n = n * r.width + r.x, i = i * r.width + r.x, a = a * r.height + r.y, o = o * r.height + r.y),
		...
		function n(t, e, r) {
			...
			s = null == e.y ? .5 : e.y,
			l = null == e.r ? .5 : e.r;
			return e.global || (o = o * n + r.x, s = s * i + r.y, l *= a),
	...
	function(t, e, r) {
		...
		c.prototype = {
			...
			animateTo: function(t, e, r, n, i, a) {
				...
				o(r) ? (i = n, n = r, r = 0) : s(n) ? (i = n, n = "linear", r = 0) : s(r) ? (i = r, r = 0) : s(e) ? (i = e, e = 500) : e || (e = 500),
				this.stopAnimation(),
			...
			_animateToShallow: function(t, e, r, n, i) {
				var a = {},
				o = 0;
				for (var s in r) if (r.hasOwnProperty(s)) if (null != e[s]) l(r[s]) && !h(r[s]) ? this._animateToShallow(t ? t + "." + s: s, e[s], r[s], n, i) : (a[s] = r[s], o++);
				else if (null != r[s]) if (t) {
					var u = {};
					u[t] = {},
					u[t][s] = r[s],
					this.attr(u)
				} else this.attr(s, r[s]);
				return o > 0 && this.animate(t, !1).when(null == n ? 500 : n, a).delay(i || 0),
				this
			}
		};
		var f = c;
	...
	function(t, e, r) {
		...
		function l(t, e, r) {
			...
			if (n !== i) {
				if (n > i) t.length = i;
				else for (var a = n; a < i; a++) t.push(1 === r ? e[a] : w.call(e[a]))
			}
			for (var o = t[0] && t[0].length, a = 0; a < t.length; a++) if (1 === r) isNaN(t[a]) && (t[a] = e[a]);
			...
			if (_) {
				...
				if (f || !O) {
					...
					var Y = function(t, e) {
						...
						j = e;
						var n = P[r + 1] - P[r];
						if (0 !== n) if (z = (e - P[r]) / n, w) if (E = I[r], N = I[0 === r ? r: r - 1], W = I[r > _ - 2 ? _ - 1 : r + 1], q = I[r > _ - 3 ? _ - 1 : r + 2], M) u(N, E, W, q, z, z * z, z * z * z, g(t, i), C);
						else {
							var l;
							if (T) l = u(N, E, W, q, z, z * z, z * z * z, X, 1),
							l = d(X);
							else {
								if (k) return o(E, W, z);
	...
	function(t, e, r) {
		...
		function s(t, e, r, n, i, a, o, s, h) {
			...
			c = l.max,
			x = Math.abs(i - a);
			if (x % v < 1e-4 && x > 1e-4) return s[0] = t - r,
			s[1] = e - n,
			h[0] = t + r,
			void(h[1] = e + n);
	...
	function(t, e, r) {
		...
		function o(t, e, r, n, i, a, o, s) {
			...
			if (h >= 0 && h <= 1) {
				for (var u = 0,
				c = x.quadraticAt(e, n, a, h), f = 0; f < l; f++) {
		...
		function s(t, e, r, n, i, a, o, s) {
			...
			f = 0; f < 2; f++) {
				...
				if (d + t > o) {
					...
					u = a ? 1 : -1;
					v < 0 && (v = _ + v),
					(v >= n && v <= i || v + _ >= n && v + _ <= i) && (v > Math.PI / 2 && v < 1.5 * Math.PI && (u = -u), c += u)
				}
			}
			return c
		}
		function l(t, e, r, i, l) {
			...
			return r || n(c, m) || (h += y(u, c, p, m, i, l) || 0),
			0 !== h
		}
		function h(t, e, r) {
			return l(t, 0, !1, e, r)
			...
			function() {
				...
				if (r) for (var i = 0; i < r.length; i++) {
					...
					if (s && ("sector" === l && s.startAngle === s.endAngle || "rect" === l && (!s.width || !s.height))) {
						for (var h = 0; h < a.length; h++) a[h][2] = n[a[h][0]],
						n[a[h][0]] = a[h][1];
						e = !0;
						break
					}
	...
	function(t, e, r) {
		...
		a = n.extend({
			...
			buildPath: function(t, e) {
				...
				a = e.width,
				o = e.height;
				e.r ? i.buildPath(t, e) : t.rect(r, n, a, o),
				t.closePath()
			}
		});
		t.exports = a
		...
		n.extendChartView({
			...
			render: function(t, e, r) {
				...
				t.layoutInstance.ondraw = function(t, e, r, s) {
					...
					n.graphic.setHoverStyle(c, n.graphic.setTextStyle({},
					u, null, {
						forMerge: !0
					},
					!0))
 ...
 */
		window.setImmediate || (window.setImmediate = function() {
			return window.msSetImmediate || window.webkitSetImmediate || window.mozSetImmediate || window.oSetImmediate ||
			function() {
				...
				if (a) {
					...
					F = function(e, r, i, a, o, s, l, h, u) {
						...
						t.forEach(function(t) {
							if (t.getContext) {
								...
								o.fillStyle = c,
								o.translate((e + i.gw / 2) * p * s, (r + i.gh / 2) * p * s),
								0 !== h && o.rotate( - h),
								...
								1 !== i.mu && (v += "translateX(-" + i.fillTextWidth / 4 + "px) scale(" + 1 / i.mu + ")");
								var g = {
									position: "absolute",
									display: "block",
					...
					N = function(e, r, n) {
						if (r) return ! t.some(function(t) {
							...
							return i.initCustomEvent(e, !0, r, n || {}),
							!t.dispatchEvent(i)
						},
						this);
						t.forEach(function(t) {
					...
					function() {
						var e = t[0];
						if (e.getContext) u = Math.ceil(e.width / p),
						c = Math.ceil(e.height / p);
						else {
							var r = e.getBoundingClientRect();
							u = Math.ceil(r.width / p),
							c = Math.ceil(r.height / p)
						}
						if (N("wordcloudstart", !0)) {
							f = n.origin ? [n.origin[0] / p, n.origin[1] / p] : [u / 2, c / 2],
							...
							if (n.hover || n.click) {
								...
								n.click && (e.addEventListener("click", C), e.addEventListener("touchstart", C), e.addEventListener("touchend",
								function(t) {
									t.preventDefault()
								}), e.style.webkitTapHighlightColor = "rgba(0, 0, 0, 0)"),
								e.addEventListener("wordcloudstart",
								function t() {
